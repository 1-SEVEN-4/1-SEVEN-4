...
import { createMember, deleteMember, getMember } from '../controllers/memberController.js';
...
groupMemberRouters.post('/:groupId/members', validateLoginCondition, validateGroupId, createMember);
groupMemberRouters.get('/:groupId/members', validateGroupId, getMember);
groupMemberRouters.delete('/:groupId/members', validateGroupId, validateLoginInfo, deleteMember);
